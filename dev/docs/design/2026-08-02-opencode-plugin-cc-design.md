> Layout note, 2026-08-25: this document predates the move to the house
> template. What it calls `scripts/` is now `src/`, and `tests/` is now
> `dev/tests/`. See `2026-08-25-template-structure-alignment-design.md`.
